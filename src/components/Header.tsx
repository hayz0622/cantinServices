...
const navLinks = [
  { label: "Accueil", path: "/" },
  {
    ...
    children: [
      ...
      { label: "Taille de haie", path: "/apprendre#taille" },
      { label: "Taille fruitière et ornementale", path: "/apprendre#taille-fruitiere" },
      { label: "Taille de formation", path: "/apprendre#taille-formation" },
