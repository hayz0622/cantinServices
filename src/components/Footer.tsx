...
const Footer = () => {
  return (
    <footer className="relative bg-secondary text-secondary-foreground overflow-hidden">
      ...
      <div className="h-1 w-full" style={{ background: "linear-gradient(90deg, hsl(80,58%,38%) 0%, hsl(35,90%,52%) 50%, hsl(80,58%,38%) 100%)" }} />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute -bottom-20 -left-20 w-64 h-64 rounded-full opacity-5" style={{ background: "radial-gradient(circle, hsl(35,90%,52%) 0%, transparent 70%)" }} />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-start gap-5">
            ...
            <p className="text-sm text-secondary-foreground/60 leading-relaxed">
              Arboristes certifiés ISA au service de la Mauricie depuis des années.
            </p>
            <p className="text-xs text-secondary-foreground/40 font-mono">NEQ : 2278444873</p>
            <a
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-secondary-foreground/80">
              <div className="flex items-center justify-between gap-4">
                ...
                <span className="font-semibold text-secondary-foreground">7h – 17h</span>
              </div>
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                  <Clock size={13} className="shrink-0 text-secondary-foreground/50" />
                ...
                <span className="font-semibold text-secondary-foreground">8h – 12h</span>
              </div>
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-2">
                  <Clock size={13} className="shrink-0 text-secondary-foreground/50" />
                ...
                <span className="font-semibold text-secondary-foreground/60">Fermé</span>
              </div>
